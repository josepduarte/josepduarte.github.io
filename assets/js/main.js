	var Zepto = function() {
	    ...
	    return X.matches = function(t, e) {
	        ...
	        var i, r = t.parentNode,
	            o = !r;
	        return o && (r = W).appendChild(t), i = ~X.qsa(r, e).indexOf(t), o && W.removeChild(t), i
	    }, S = function(t) {
	        ...
	        var i, r, a;
	        return Z.test(t) && (i = j(P.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(_, "<$1></$2>")), e === w && (e = L.test(t) && RegExp.$1), e in I || (e = "*"), a = I[e], a.innerHTML = "" + t, i = j.each(N.call(a.childNodes), function() {
	            a.removeChild(this)
	        })), o(n) && (r = j(i), j.each(n, function(t, e) {
	            M.indexOf(t) > -1 ? r[t](e) : r.attr(t, e)
	        })), i
	    }, X.Z = function(t, e) {
	        ...
	        if (!t) return X.Z();
	        if ("string" == typeof t)
	            if (t = t.trim(), "<" == t[0] && L.test(t)) i = X.fragment(t, RegExp.$1, n), t = null;
	            else {
	            ...
	            else if (L.test(t)) i = X.fragment(t.trim(), RegExp.$1, n), t = null;
	            else {
	                if (n !== w) return j(n).find(t);
	                i = X.qsa(P, t)
	            }
	        ...
	        not: function(t) {
	            ...
	            if (e(t) && t.call !== w) this.each(function(e) {
	                ...
	                var i = "string" == typeof t ? this.filter(t) : a(t) && e(t.item) ? N.call(t) : j(t);
	        ...
	        closest: function(t, e) {
	            var n = this[0],
	                r = !1;
	            for ("object" == typeof t && (r = j(t)); n && !(r ? r.indexOf(n) >= 0 : X.matches(n, t));) n = n !== e && !i(n) && n.parentNode;
	            return j(n)
	        },
	        parents: function(t) {
	        ...
	        j.fn[e] = function() {
	            ...
	            return o.length < 1 ? this : this.each(function(t, e) {
	                ...
	                var s = j.contains(P.documentElement, r);
	...
	window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
	    ...
	    function(t) {
	        ...
	        S.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
	            ...
	            i(r), r.crossDomain || (n = y.createElement("a"), n.href = r.url, n.href = n.href, r.crossDomain = S.protocol + "//" + S.host != n.protocol + "//" + n.host), r.url || (r.url = window.location.toString()), h(r);
	            var p = r.dataType,
	                d = /\?.+=\?/.test(r.url);
	            if (d && (p = "jsonp"), r.cache !== !1 && (e && e.cache === !0 || "script" != p && "jsonp" != p) || (r.url = f(r.url, "_=" + Date.now())), "jsonp" == p) return d || (r.url = f(r.url, r.jsonp ? r.jsonp + "=?" : r.jsonp === !1 ? "" : "callback=?")), t.ajaxJSONP(r, c);
	            var v, b = r.accepts[p],
	                x = {},
	                w = function(t, e) {
	                    x[t.toLowerCase()] = [t, e]
	            ...
	            if (c && c.promise(j), r.crossDomain || w("X-Requested-With", "XMLHttpRequest"), w("Accept", b || "*/*"), (b = r.mimeType || b) && (b.indexOf(",") > -1 && (b = b.split(",", 2)[0]), j.overrideMimeType && j.overrideMimeType(b)), (r.contentType || r.contentType !== !1 && r.data && "GET" != r.type.toUpperCase()) && w("Content-Type", r.contentType || "application/x-www-form-urlencoded"), r.headers)
	                for (g in r.headers) w(g, r.headers[g]);
	            if (j.setRequestHeader = w, j.onreadystatechange = function() {
	                    if (4 == j.readyState) {
	                        ...
	                        if (j.status >= 200 && j.status < 300 || 304 == j.status || 0 == j.status && "file:" == E) {
	                            ...
	                            n ? s(n, "parsererror", j, r, c) : a(e, j, r, c)
	                        } else s(j.statusText || null, j.status ? "error" : "abort", j, r, c)
	                    }
	                }, o(j, r) === !1) return j.abort(), s(null, "abort", j, r, c), j;
	            if (r.xhrFields)
	                for (g in r.xhrFields) j[g] = r.xhrFields[g];
	            var k = !("async" in r) || r.async;
	            j.open(r.type, r.url, k, r.username, r.password);
	            for (g in x) T.apply(j, x[g]);
	            return r.timeout > 0 && (v = setTimeout(function() {
	                j.onreadystatechange = u, j.abort(), s(null, "timeout", j, r, c)
	    ...
	    function(t) {
	        t.fn.simpleJekyllSearch = function(e) {
	            function n() {
	                u.keyup(function(e) {
	                    t(this).val().length ? r(i(t(this).val())) : o()
	                })
	            }
	            ...
	            function i(e) {
	                ...
	                return t.each(c, function(t, i) {
	                    for (var t = 0; t < s.length; t++) void 0 !== i[s[t]] && i[s[t]].toLowerCase().indexOf(e.toLowerCase()) !== -1 && (n.push(i), t = s.length)
	                }), n
	            }
	            ...
	            function r(e) {
	                o(), l.append(t(a.searchResultsTitle)), e.length ? t.each(e, function(e, n) {
	                    if (e < a.limit) {
	                        for (var i = a.template, e = 0; e < s.length; e++) {
	                            var r = new RegExp("{" + s[e] + "}", "g");
	                            i = i.replace(r, n[s[e]])
	                        }
	                        l.append(t(i))
	                    }
